...
title: "AI时代的有闲阶级"
date: "2026-04-12"
excerpt: "127年前凡勃伦发现，有闲阶级用「不劳动」来证明地位。2026年，新有闲阶级用「不亲自执行」来证明地位——但这批人真的是新贵族吗，还是只是暂时站在工具浪尖上的劳动者？"
...
所以更诚实的说法是：新有闲阶级的「闲」，其实是一种**表演**。喝咖啡的画面是真的，但那杯咖啡之前，人已经在脑子里把系统架构过了三遍。凡勃伦笔下的贵族是真的不劳动，2026 年的这批人只是把劳动从手上换到了脑子里，然后挑了脑力劳动中最不可见的那部分——判断——作为新的身份符号。
...
凡勃伦时代的贵族之所以能「有闲」，底层逻辑是他们掌握着**生产资料**——土地、资本、不可复制的继承权。这些东西有排他性，别人抢不走，所以那个阶层能稳定两三代人。

但 Agent、大模型、Prompt 工作流，本质上只是**生产工具**。工具的宿命就是普及。今天你的 CLAUDE.md 写得像艺术品，是因为大多数人还没搞明白怎么用；等到 Claude Code 再迭代两个版本、Cursor 再傻瓜化一点，这套「熟练度优越感」会在一夜之间被抹平。
